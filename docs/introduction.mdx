...
<CardGroup cols={2}>
  <Card title="Run your first benchmark" icon="play" href="/get-started/quickstart">
    Install the CLI, configure credentials, and start a run.
  </Card>
  <Card title="Manage agents" icon="robot" href="/agents/manage-agents">
    Upload, list, download, and remove agent bundles.
  </Card>
  <Card title="Add a benchmark service" icon="server" href="/benchmarks/custom-services">
    Connect Valkyrie to a custom benchmark endpoint.
  </Card>
  <Card title="Self-host Valkyrie" icon="cloud" href="/self-hosting/infrastructure">
