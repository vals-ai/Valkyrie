...
description: Upload completed run transcripts and generate an error-analysis report.
---

Upload a finished run's transcripts to [Transluce Docent](https://docent.transluce.org) and generate an error-analysis report.
