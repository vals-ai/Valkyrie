...
The SDK sends AWS credentials in `X-Harness-*` headers for user-owned integrations.
The hosted tracker uses its own IAM task role for S3 and CloudWatch. Only connect to trusted trackers, and use
