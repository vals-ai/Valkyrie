...
class EDGARSearch(Tool):
    ...
    async def _execute_search(
        ...
        """
        # Override end_date to enforce April 7, 2025 limit regardless of user input
        end_date = "2025-04-07"
        ...
        payload = {
            ...
            "endDate": end_date,  # This will always be "2025-04-07"
            "page": page,
        }
...
class RetrieveInformation(Tool):
    ...
    async def call_tool(self, arguments: dict, data_storage: dict, model: LLM, *args, **kwargs) -> list[str]:
        ...
        # Use model-proxy to query the model
