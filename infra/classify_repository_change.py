...
_EXECUTOR_STACK_FILES = {
    ...
    "infra/constants.py",
    "infra/executor_release.py",
    "infra/shared.py",
    "infra/stage.py",
    "infra/stage_config.py",
    "infra/worker_stack.py",
    "services/tracker/src/executor_protocol.py",
    "services/tracker/src/tracker/maintenance_control.py",
    "services/tracker/src/tracker/release_control.py",
    "services/tracker/src/tracker/release_entrypoint.py",
}
...
_EXECUTOR_RELEASE_FILES = {
    "services/tracker/build_executor_artifact.py",
    ...
    "services/tracker/src/tracker/dispatch_control.py",
    "services/tracker/src/tracker/docent_analysis.py",
    "services/tracker/src/tracker/exceptions.py",
    "services/tracker/src/tracker/execution_authority.py",
