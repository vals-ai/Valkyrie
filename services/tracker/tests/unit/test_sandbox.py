"""Unit tests for tracker sandbox helpers.

Run: uv run pytest tests/unit/test_sandbox.py

Covers tracker-owned sandbox orchestration, output artifact handling, provider
error mapping, and run_agent behavior. Add cases here when behavior can be
verified without live provider calls.
"""
