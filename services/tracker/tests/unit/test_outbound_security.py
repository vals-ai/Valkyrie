...
class TestBenchmarkServiceNameValidation:
    ...
    def test_benchmark_name_rejects_url_parser_control(self, benchmark_name: str) -> None:
    ...
    def test_benchmark_name_preserves_supported_dns_label(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestCustomServiceUrlValidation:
    ...
    def test_custom_service_url_rejects_parser_and_credential_controls(self, service_url: str) -> None:
    ...
    def test_custom_service_url_preserves_intentional_internal_http_service(self) -> None:
