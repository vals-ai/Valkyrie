...
def test_list_agents_returns_storage_metadata(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_agent_download_url_uses_route_expiration(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_agent_download_url_returns_not_found_for_missing_agent(monkeypatch: pytest.MonkeyPatch) -> None:
