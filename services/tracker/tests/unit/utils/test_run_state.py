...
class TestRunState:
    ...
    def test_stop_benchmark(
        ...
        def capture_locked_fetch(
            ...
            *,
            ...
            return fetch_run_row(benchmark_id, session, org, for_update=for_update)

        monkeypatch.setattr("main.fetch_run_row", capture_locked_fetch)
    ...
    async def test_set_run_final_status(
        self,
        example_benchmark_object: Benchmark,
        database_session: Session,
        executor_authority: Any,
        ...
        with pytest.raises(TrackerServiceError):
            set_run_final_status(benchmark_row, database_session, self._test_org, authority=authority)
