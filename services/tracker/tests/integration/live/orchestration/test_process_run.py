...
class TestProcessRun:
    ...
    async def test_process_run(
        ...
        await process_run(request.model_dump(), str(benchmark.id), _TASK_IDS, **authority_kwargs)
    ...
    async def test_process_run_error(
        ...
        await process_run(request.model_dump(), str(benchmark.id), [_TASK_ID], **authority_kwargs)
    ...
    async def test_process_task_error(
        ...
        await process_run(request.model_dump(), str(benchmark.id), task_ids, **authority_kwargs)
