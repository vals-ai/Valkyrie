...
def get_filter_options(
    ...
    # TODO: push this down to SQL once unit tests run on Postgres (currently SQLite).
    # Agent name lives at arguments.contract.name; Postgres `arguments->'contract'->>'name'`
    # would do this in one query, but SQLite's `json_extract` syntax differs.
