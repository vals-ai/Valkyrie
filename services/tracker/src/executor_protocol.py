...
MANAGED_EXECUTION_PROTOCOL_VERSIONS = frozenset({MANAGED_EXECUTION_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSION})
RESOURCE_BOUND_EXECUTION_PROTOCOL_VERSION = "3"
