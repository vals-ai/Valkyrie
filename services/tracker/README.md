...
BENCHMARK_CATALOG_URL=          # API Gateway catalog endpoint for tenant-visible hosted services
BENCHMARK_SERVICE_NAMES=        # Comma-separated hosted benchmark service names to list
