...
from tracker.database.models import AgentContractRequest, DocentReadingStatus, TaskStatus
from tracker.types import GetRunResponse, RunArguments, RunDetails, RunMetadataResponse, RunResultsResponse, RunStatus
...
def make_fetch_metadata(run_id: UUID) -> RunMetadataResponse:
